...
function Example() {
  ...
  return <div className="mx-auto w-full max-w-xl space-y-5"><><label className="space-y-2 text-sm">Color family<UI.NativeSelect defaultValue="violet"><UI.NativeSelectOption value="violet">Violet</UI.NativeSelectOption><UI.NativeSelectOption value="graphite">Graphite</UI.NativeSelectOption></UI.NativeSelect></label><UI.NativeSelect disabled aria-label="Disabled color family"><UI.NativeSelectOption>Locked</UI.NativeSelectOption></UI.NativeSelect></></div>
}
