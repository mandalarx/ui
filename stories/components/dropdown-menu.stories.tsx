...
function Example() {
  ...
  return <div className="mx-auto w-full max-w-xl space-y-5"><UI.DropdownMenu><UI.DropdownMenuTrigger asChild><Button variant="outline">Collection actions</Button></UI.DropdownMenuTrigger><UI.DropdownMenuContent><UI.DropdownMenuLabel>Azure Blueprint</UI.DropdownMenuLabel><UI.DropdownMenuItem>Rename</UI.DropdownMenuItem><UI.DropdownMenuItem>Duplicate</UI.DropdownMenuItem><UI.DropdownMenuItem>Export tokens</UI.DropdownMenuItem><UI.DropdownMenuSeparator /><UI.DropdownMenuItem disabled>Delete published version</UI.DropdownMenuItem></UI.DropdownMenuContent></UI.DropdownMenu></div>
}
