...
function Example() {
  ...
  return <div className="mx-auto w-full max-w-xl space-y-5"><UI.Popover><UI.PopoverTrigger asChild><Button variant="outline">Quick settings</Button></UI.PopoverTrigger><UI.PopoverContent><UI.PopoverHeader><UI.PopoverTitle>Collection</UI.PopoverTitle><UI.PopoverDescription>Adjust the name without leaving your view.</UI.PopoverDescription></UI.PopoverHeader><label className="mt-4 block space-y-2 text-sm">Name<Input defaultValue="Azure Blueprint" /></label></UI.PopoverContent></UI.Popover></div>
}
