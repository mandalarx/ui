...
function Example() {
  ...
  return <div className="mx-auto w-full max-w-xl space-y-5"><><label className="space-y-2 text-sm">Collection name<UI.Input placeholder="Violet Atelier" /></label><label className="space-y-2 text-sm">Invalid slug<UI.Input aria-invalid aria-describedby="input-error" defaultValue="violet atelier" /></label><p id="input-error" className="text-sm text-destructive">Use hyphens instead of spaces.</p><UI.Input aria-label="Disabled input" disabled placeholder="Read only workspace" /></></div>
}
