...
createRoot(document.getElementById("root")!).render(<>
  ...
  <main className="mx-auto max-w-5xl px-8">
    {["home", "guide", "features", "about", "start"].map(id => <section key={id} id={id} className="min-h-96 scroll-mt-32 py-16"><h1 className="text-4xl font-semibold capitalize">{id}</h1><p className="mt-6">A plain React app with Azure Glass navigation.</p></section>)}
  </main>
</>)
